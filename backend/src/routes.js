...
import StudentControllerMobile from './app/controllers/StudentControllerMobile';
...
routes.get('/students/:id', StudentControllerMobile.show);
...
routes.get('/students', StudentControllerMobile.show);
